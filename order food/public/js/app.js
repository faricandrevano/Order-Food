...
var rupiah = function rupiah(number) {
...
function initAdmin(socket) {
  var orderTableBody = document.querySelector('#orderTabelBody');
  var orders = [];
  var markup;
  ...
  function renderItems(items) {
    ...
    return Array.from(parsedItems).map(function (menuItem) {
      return "\n                <p class=\"mb-4\">".concat(menuItem.item.name, "</p>\n            ");
    }).join('');
  }
  function renderItemsQty(items) {
    var parsedItems = Object.values(items);
    return parsedItems.map(function (menuItem) {
      return "\n                <p class=\"mb-4\">".concat(menuItem.qty, "</p>\n            ");
    }).join('');
  }
  function renderPrice(items) {
    var parsedItems = Object.values(items);
    return parsedItems.map(function (menuItem) {
      return "\n                <p class=\"mb-4\">".concat(menuItem.item.price, "</p>\n            ");
    }).join('');
  }
  function renderImage(items) {
    var parsedItems = Object.values(items);
    return parsedItems.map(function (menuImage) {
      return "<img src=\"".concat(menuImage.item.image, "\" width=\"30\" class=\"block mb-4\">");
    }).join('');
  }
  function generateMarkup(orders) {
    return orders.map(function (order) {
      return "\n                <tr>\n                <td class=\"border px-4 py-2 text-green-900\">\n                    <div>\n                        <div class=\"flex justify-around items-center\">\n                            <span class=\"block\">".concat(renderImage(order.items), "</span>\n                            <span class=\"block\">").concat(renderItems(order.items), "</span>\n                        </div>\n                    </div>\n                </td>\n                <td class=\"border px-4 py-2\">").concat(renderItemsQty(order.items), "</td>\n                <td class=\"border px-4 py-2\">").concat(renderPrice(order.items), "</td>\n                <td class=\"border px-4 py-2\">").concat(order.customerId.name, "</td>\n                <td class=\"border px-4 py-2\">").concat(order.adress, "</td>\n                <td class=\"border px-4 py-2\">\n                    ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('LLLL'), "\n                </td>\n                <td class=\"border px-4 py-2\">\n                    <div class=\"inline-block relative w-64\">\n                        <form action=\"/admin/order/status\" method=\"POST\">\n                            <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n                            <select name=\"status\" onchange=\"this.form.submit()\"\n                                class=\"block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline\">\n                                <option value=\"on-proses\"\n                                    ").concat(order.status === 'on-proses' ? 'selected' : '', ">\n                                    on-proses</option>\n                                <option class=\"opsiComplete\" value=\"complete\" ").concat(order.status === 'complete' ? 'selected' : '', ">\n                                    complete</option>\n                            </select>\n                        </form>\n                    </div>\n                </td>\n            </tr>\n        ");
    }).join('');
  }
  // Socket
...
function removeItem(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/remove-item', pizza).then(function (res) {
...
addToCart.forEach(function (event) {
  event.addEventListener('click', function (e) {
    var pizzas = JSON.parse(event.dataset.pizza);
    updateCart(pizzas);
  });
});
btnRemove.forEach(function (event) {
  event.addEventListener('click', function (e) {
    var pizzas = JSON.parse(event.dataset.pizzaid);
    console.log(pizzas);
    removeItem(pizzas);
    // console.log(pizzas)
  });
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, card, paymentType;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)('pk_test_51M1fKHLl96ZaZkGUvK6aJLH48ofHalqJD8FZIvBNKdYrfmMiUNYHGIvMWXIXJz2vlhIYmiZ4hZ2EZ3lmV1wOCdjW00Ahzw3y1b');
          case 2:
